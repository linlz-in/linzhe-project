...
import com.retailersv1.domain.TrafficPageViewBean;
...
//        beanDs.print();
        ...
        SingleOutputStreamOperator<TrafficPageViewBean> reduceDs = windowDs.reduce(new ReduceFunction<TrafficPageViewBean>() {
            @Override
            public TrafficPageViewBean reduce(TrafficPageViewBean t1, TrafficPageViewBean t2) {
            ...
            public void apply(Tuple4<String, String, String, String> stringStringStringStringTuple4,
                              ...
                              Iterable<TrafficPageViewBean> iterable, Collector<TrafficPageViewBean> collector) {
