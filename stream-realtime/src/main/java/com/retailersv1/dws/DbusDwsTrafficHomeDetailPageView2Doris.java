...
import com.retailersv1.domain.TrafficHomeDetailPageViewBean;
...
//        processDs.print();
        ...
        SingleOutputStreamOperator<TrafficHomeDetailPageViewBean> reduceDs = windowDs.reduce(new ReduceFunction<TrafficHomeDetailPageViewBean>() {
            ...
            @Override
            public TrafficHomeDetailPageViewBean reduce(TrafficHomeDetailPageViewBean t1, TrafficHomeDetailPageViewBean t2) {
            ...
            @Override
            public void apply(TimeWindow timeWindow, Iterable<TrafficHomeDetailPageViewBean> iterable, Collector<TrafficHomeDetailPageViewBean> collector) {
