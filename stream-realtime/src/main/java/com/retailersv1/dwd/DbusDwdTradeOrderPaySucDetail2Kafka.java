...
import com.stream.common.utils.SqlUtils;
...
public class DbusDwdTradeOrderPaySucDetail2Kafka {
    ...
    public static void main(String[] args) {
        ...
        tableEnv.executeSql("CREATE TABLE ods_ecommerce_order (\n" +
                ...
                ")" + SqlUtils.getKafka(ODS_KAFKA_TOPIC, "retailersv_dwd_trade_payment_success"));
        // 1. 读取下单事务事实表
        tableEnv.executeSql(
                "create table dwd_trade_order_detail(" +
                        ...
                        " WATERMARK FOR time_ltz AS time_ltz - INTERVAL '5' SECOND" +
                        ")" + SqlUtils.getKafka(DWD_TRADE_ORDER_DETAIL, "retailersv_dwd_trade_payment_success"));
...
//        paymentInfo.execute().print();
        ...
        tableEnv.executeSql("CREATE TABLE base_dic (\n" +
                ...
                ")"+SqlUtils.getHbaseDDL("dim_base_dic"));
...
//        result.execute().print();
        ...
        tableEnv.executeSql("create table "+DWD_TRADE_ORDER_PAYMENT_SUCCESS+"(" +
                ...
                ")" + SqlUtils.getUpsertKafkaDDL(DWD_TRADE_ORDER_PAYMENT_SUCCESS));
