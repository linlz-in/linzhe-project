...
public class DbusDwdTradeOrderCancelDetail2Kafka {
    ...
    public static void main(String[] args) {
        ...
        tableEnv.executeSql("CREATE TABLE ods_ecommerce_order (\n" +
                ...
                ")" + SqlUtils.getKafka(ODS_KAFKA_TOPIC, "retailersv_dwd_order_cancel_detail"));
...
//        orderCancel.execute().print();
        ...
        tableEnv.executeSql(
                "create table dwd_trade_order_detail(" +
                        ...
                        "ts bigint " +
                        ")" + SqlUtils.getKafka(DWD_TRADE_ORDER_DETAIL, "retailersv_dwd_order_cancel_detail"));
...
//        result.execute().print();
        ...
        tableEnv.executeSql(
                "create table "+DWD_TRADE_ORDER_CANCEL_DETAIL+"(" +
                        ...
                        ")" + SqlUtils.getUpsertKafkaDDL(DWD_TRADE_ORDER_CANCEL_DETAIL));
